...
h1.setAttribute('id', 'titulito'); /* id="titulito" */
h1.setAttribute('hola', "valorHola"); /* le damos un atributo id al h1 */

console.log(h1.getAttribute('id')); /* obtenemos el valor de ese id */
...
enviar.style.fontSize = '60px'; /* agrega estilos en linea */

/* INPUTS */

miInput.value = '031203120';
miInput.type = 'text';
...
console.log(h1.classList[0]);  // devuelve una clase según su índice

console.log(h1.classList.contains('nuevaClase')); 
// Nos devuelve un booleano dependiendo si contiene o no la clase

h1.classList.replace('nuevaClase', 'nuevaClase2'); 
...
textoDinamico.innerHTML = `soy un texto con <span>con inner html</span>`;
...
/* -------------------------- */
/* CREACION, RENDERIZADO Y DES-RENDIZADO DE ELEMENTOS */
...
console.log(divPadre.hasChildNodes()); // Tiene hijos?? True/False
...
console.log(miInput.parentElement);
console.log(miInput.parentNode);
...
// Busca el elemento que contenga al selector más cercano
